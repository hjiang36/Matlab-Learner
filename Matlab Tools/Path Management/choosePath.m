...
if ispc
    ...
    folderPath  = {'iset', {'UnitTestToolbox', 'RemoteDataToolbox', 'isetbio'}, ...
        {'isetbio', 'RemoteDataToolbox', 'UnitTestToolbox', 'frontend'}, ...
        'colorVisionExperiment', 'Matlab-Learner', {'iset', 'L3'}};
else
    % Mac or Linux system
    basePath = '~/';
    folderNames = {'ISET', 'ISETBio', 'Frontend', ...
